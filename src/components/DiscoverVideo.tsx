          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-base md:text-lg text-[#02176f] max-w-lg mx-auto md:mx-0 leading-relaxed md:pl-10">
              {isCatholic
                ...
                : 'Discover books that foster creativity, imagination, and wonder — providing easy access to exceptional literature for schools and families. Books that can edify, shape character, and deepen virtue.'}
            </p>
          </div>
